...
This project has been replaced with [https://github.com/TechHog8984/luau-format](luau-format). It is much better (Windows support, less bugs, etc) and has an easier-to-work-with codebase.
